...
namespace Komga.Client.Model
{
    ...
    /// Is
    /// </summary>
    [DataContract(Name = "Is")]
    public partial class Is : IValidatableObject
    {
        /// <summary>
        ...
        public Is(string varOperator = default, Object value = default)
        {
            // to ensure "varOperator" is required (not null)
            if (varOperator == null)
            {
                throw new ArgumentNullException("varOperator is a required property for Is and cannot be null");
            }
            this.Operator = varOperator;
            // to ensure "value" is required (not null)
            if (value == null)
            {
                throw new ArgumentNullException("value is a required property for Is and cannot be null");
            }
            this.Value = value;
        }
