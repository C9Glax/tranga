...
namespace Komga.Client.Model
{
    ...
    /// LibraryId
    /// </summary>
    [DataContract(Name = "LibraryId")]
    public partial class LibraryId : IValidatableObject
    {
        /// <summary>
        ...
        /// Initializes a new instance of the <see cref="LibraryId" /> class.
        /// </summary>
        /// <param name="varLibraryId">varLibraryId (required).</param>
        public LibraryId(LibraryIdAllOfLibraryId varLibraryId = default)
        {
            // to ensure "varLibraryId" is required (not null)
            if (varLibraryId == null)
            {
                throw new ArgumentNullException("varLibraryId is a required property for LibraryId and cannot be null");
            }
            this.VarLibraryId = varLibraryId;
        }

        /// <summary>
        /// Gets or Sets VarLibraryId
        /// </summary>
        [DataMember(Name = "libraryId", IsRequired = true, EmitDefaultValue = true)]
        public LibraryIdAllOfLibraryId VarLibraryId { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class LibraryId {\n");
            sb.Append("  VarLibraryId: ").Append(VarLibraryId).Append("\n");
            sb.Append("}\n");
            return sb.ToString();
        }
