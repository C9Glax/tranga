...
namespace Komga.Client.Model
{
    ...
    /// IsTrue
    /// </summary>
    [DataContract(Name = "IsTrue")]
    public partial class IsTrue : Boolean, IValidatableObject
    {
        /// <summary>
        ...
        /// Initializes a new instance of the <see cref="IsTrue" /> class.
        /// </summary>
        /// <param name="varOperator">varOperator (required) (default to &quot;IsTrue&quot;).</param>
        public IsTrue(string varOperator = @"IsTrue") : base(varOperator)
        {
        }
