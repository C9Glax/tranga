...
namespace Komga.Client.Model
{
    ...
    /// ThumbnailBookDto
    /// </summary>
    [DataContract(Name = "ThumbnailBookDto")]
    public partial class ThumbnailBookDto : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ThumbnailBookDto" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected ThumbnailBookDto() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="ThumbnailBookDto" /> class.
        /// </summary>
        ...
        public ThumbnailBookDto(string bookId = default, long fileSize = default, int height = default, string id = default, string mediaType = default, bool selected = default, string type = default, int width = default)
        {
            // to ensure "bookId" is required (not null)
            if (bookId == null)
            {
                throw new ArgumentNullException("bookId is a required property for ThumbnailBookDto and cannot be null");
            }
            this.BookId = bookId;
            ...
            if (id == null)
            {
                throw new ArgumentNullException("id is a required property for ThumbnailBookDto and cannot be null");
            }
            this.Id = id;
            // to ensure "mediaType" is required (not null)
            if (mediaType == null)
            {
                throw new ArgumentNullException("mediaType is a required property for ThumbnailBookDto and cannot be null");
            }
            ...
            if (type == null)
            {
                throw new ArgumentNullException("type is a required property for ThumbnailBookDto and cannot be null");
            }
            this.Type = type;
            this.Width = width;
        }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ThumbnailBookDto {\n");
