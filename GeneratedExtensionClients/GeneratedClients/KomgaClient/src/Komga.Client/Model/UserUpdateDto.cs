...
namespace Komga.Client.Model
{
    ...
    /// UserUpdateDto
    /// </summary>
    [DataContract(Name = "UserUpdateDto")]
    public partial class UserUpdateDto : IValidatableObject
    {
        /// <summary>
        ...
        public UserUpdateDto(AgeRestrictionUpdateDto ageRestriction = default, List<string> labelsAllow = default, List<string> labelsExclude = default, List<string> roles = default, SharedLibrariesUpdateDto sharedLibraries = default)
        {
