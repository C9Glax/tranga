...
namespace Komga.Client.Model
{
    ...
    public partial class Poster : IValidatableObject
    {
        /// <summary>
        ...
        /// Initializes a new instance of the <see cref="Poster" /> class.
        /// </summary>
        /// <param name="varPoster">varPoster (required).</param>
        public Poster(PosterAllOfPoster varPoster = default)
        {
            // to ensure "varPoster" is required (not null)
            if (varPoster == null)
            {
                throw new ArgumentNullException("varPoster is a required property for Poster and cannot be null");
            }
            this.VarPoster = varPoster;
        }

        /// <summary>
        /// Gets or Sets VarPoster
        /// </summary>
        [DataMember(Name = "poster", IsRequired = true, EmitDefaultValue = true)]
        public PosterAllOfPoster VarPoster { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("  VarPoster: ").Append(VarPoster).Append("\n");
            sb.Append("}\n");
            return sb.ToString();
        }
