...
namespace Komga.Client.Model
{
    ...
    /// DirectoryRequestDto
    /// </summary>
    [DataContract(Name = "DirectoryRequestDto")]
    public partial class DirectoryRequestDto : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="DirectoryRequestDto" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected DirectoryRequestDto() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="DirectoryRequestDto" /> class.
        /// </summary>
        /// <param name="path">path (required).</param>
        /// <param name="showFiles">showFiles (required).</param>
        public DirectoryRequestDto(string path = default, bool showFiles = default)
        {
            // to ensure "path" is required (not null)
            if (path == null)
            {
                throw new ArgumentNullException("path is a required property for DirectoryRequestDto and cannot be null");
            }
            this.Path = path;
        ...
        /// </summary>
        [DataMember(Name = "showFiles", IsRequired = true, EmitDefaultValue = true)]
        ...
        public override string ToString()
        {
            ...
            sb.Append("class DirectoryRequestDto {\n");
