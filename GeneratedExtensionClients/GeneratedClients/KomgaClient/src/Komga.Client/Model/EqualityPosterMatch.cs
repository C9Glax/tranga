...
namespace Komga.Client.Model
{
    ...
    /// EqualityPosterMatch
    /// </summary>
    [DataContract(Name = "EqualityPosterMatch")]
    public partial class EqualityPosterMatch : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="EqualityPosterMatch" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected EqualityPosterMatch() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="EqualityPosterMatch" /> class.
        /// </summary>
        /// <param name="varOperator">varOperator (required).</param>
        public EqualityPosterMatch(string varOperator = default)
        {
            // to ensure "varOperator" is required (not null)
            if (varOperator == null)
            {
                throw new ArgumentNullException("varOperator is a required property for EqualityPosterMatch and cannot be null");
            }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class EqualityPosterMatch {\n");
