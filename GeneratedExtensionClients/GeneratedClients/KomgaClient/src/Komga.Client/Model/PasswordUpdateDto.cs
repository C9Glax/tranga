...
namespace Komga.Client.Model
{
    ...
    /// PasswordUpdateDto
    /// </summary>
    [DataContract(Name = "PasswordUpdateDto")]
    public partial class PasswordUpdateDto : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PasswordUpdateDto" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected PasswordUpdateDto() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="PasswordUpdateDto" /> class.
        /// </summary>
        /// <param name="password">password (required).</param>
        public PasswordUpdateDto(string password = default)
        {
            // to ensure "password" is required (not null)
            if (password == null)
            {
                throw new ArgumentNullException("password is a required property for PasswordUpdateDto and cannot be null");
            }
