...
namespace Komga.Client.Model
{
    ...
    /// </summary>
    [DataContract(Name = "TachiyomiReadProgressUpdateV2Dto")]
    public partial class TachiyomiReadProgressUpdateV2Dto : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TachiyomiReadProgressUpdateV2Dto" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected TachiyomiReadProgressUpdateV2Dto() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="TachiyomiReadProgressUpdateV2Dto" /> class.
        /// </summary>
        /// <param name="lastBookNumberSortRead">lastBookNumberSortRead (required).</param>
        public TachiyomiReadProgressUpdateV2Dto(float lastBookNumberSortRead = default)
        {
            this.LastBookNumberSortRead = lastBookNumberSortRead;
        }

        /// <summary>
        /// Gets or Sets LastBookNumberSortRead
        /// </summary>
        [DataMember(Name = "lastBookNumberSortRead", IsRequired = true, EmitDefaultValue = true)]
        public float LastBookNumberSortRead { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TachiyomiReadProgressUpdateV2Dto {\n");
            sb.Append("  LastBookNumberSortRead: ").Append(LastBookNumberSortRead).Append("\n");
            sb.Append("}\n");
            return sb.ToString();
        }
