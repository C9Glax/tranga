...
namespace Komga.Client.Model
{
    ...
    /// </summary>
    [DataContract(Name = "ThumbnailReadListDto")]
    public partial class ThumbnailReadListDto : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ThumbnailReadListDto" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected ThumbnailReadListDto() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="ThumbnailReadListDto" /> class.
        /// </summary>
        ...
        /// <param name="readListId">readListId (required).</param>
        /// <param name="selected">selected (required).</param>
        /// <param name="type">type (required).</param>
        /// <param name="width">width (required).</param>
        public ThumbnailReadListDto(long fileSize = default, int height = default, string id = default, string mediaType = default, string readListId = default, bool selected = default, string type = default, int width = default)
        {
            ...
            if (id == null)
            {
                throw new ArgumentNullException("id is a required property for ThumbnailReadListDto and cannot be null");
            }
            this.Id = id;
            // to ensure "mediaType" is required (not null)
            if (mediaType == null)
            {
                throw new ArgumentNullException("mediaType is a required property for ThumbnailReadListDto and cannot be null");
            }
            this.MediaType = mediaType;
            // to ensure "readListId" is required (not null)
            if (readListId == null)
            {
                throw new ArgumentNullException("readListId is a required property for ThumbnailReadListDto and cannot be null");
            }
            ...
            if (type == null)
            {
                throw new ArgumentNullException("type is a required property for ThumbnailReadListDto and cannot be null");
            }
            this.Type = type;
            this.Width = width;
        }
        ...
        /// <summary>
        /// Gets or Sets ReadListId
        /// </summary>
        [DataMember(Name = "readListId", IsRequired = true, EmitDefaultValue = true)]
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ThumbnailReadListDto {\n");
            sb.Append("  FileSize: ").Append(FileSize).Append("\n");
            sb.Append("  Height: ").Append(Height).Append("\n");
            sb.Append("  Id: ").Append(Id).Append("\n");
            sb.Append("  MediaType: ").Append(MediaType).Append("\n");
            sb.Append("  ReadListId: ").Append(ReadListId).Append("\n");
