...
namespace Komga.Client.Model
{
    ...
    /// IsNotNull
    /// </summary>
    [DataContract(Name = "IsNotNull")]
    public partial class IsNotNull : Date, IValidatableObject
    {
        /// <summary>
        ...
        /// Initializes a new instance of the <see cref="IsNotNull" /> class.
        /// </summary>
        /// <param name="varOperator">varOperator (required) (default to &quot;IsNotNull&quot;).</param>
        public IsNotNull(string varOperator = @"IsNotNull") : base(varOperator)
        {
        }
