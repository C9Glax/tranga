...
namespace Komga.Client.Model
{
    ...
    /// PageSeriesDto
    /// </summary>
    [DataContract(Name = "PageSeriesDto")]
    public partial class PageSeriesDto : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PageSeriesDto" /> class.
        /// </summary>
        ...
        public PageSeriesDto(List<SeriesDto> content = default, bool empty = default, bool first = default, bool last = default, int number = default, int numberOfElements = default, PageableObject pageable = default, int size = default, SortObject sort = default, long totalElements = default, int totalPages = default)
        {
        ...
        public List<SeriesDto> Content { get; set; }
