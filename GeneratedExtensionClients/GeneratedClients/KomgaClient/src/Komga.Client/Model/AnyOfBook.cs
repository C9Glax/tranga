...
namespace Komga.Client.Model
{
    ...
    /// AnyOfBook
    /// </summary>
    [DataContract(Name = "AnyOfBook")]
    public partial class AnyOfBook : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="AnyOfBook" /> class.
        /// </summary>
        ...
        public AnyOfBook(List<AnyOfBookAllOfAnyOf> anyOf = default)
        {
            // to ensure "anyOf" is required (not null)
            if (anyOf == null)
            {
                throw new ArgumentNullException("anyOf is a required property for AnyOfBook and cannot be null");
            }
            this.AnyOf = anyOf;
        }
        ...
        public List<AnyOfBookAllOfAnyOf> AnyOf { get; set; }
