...
namespace Komga.Client.Model
{
    ...
    /// Boolean
    /// </summary>
    [DataContract(Name = "Boolean")]
    [JsonConverter(typeof(JsonSubtypes), "Operator")]
    [JsonSubtypes.KnownSubType(typeof(IsFalse), "IsFalse")]
    [JsonSubtypes.KnownSubType(typeof(IsTrue), "IsTrue")]
    public partial class Boolean : IValidatableObject
    {
        /// <summary>
        ...
        public Boolean(string varOperator = default)
        {
            // to ensure "varOperator" is required (not null)
            if (varOperator == null)
            {
                throw new ArgumentNullException("varOperator is a required property for Boolean and cannot be null");
            }
