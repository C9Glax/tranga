...
namespace Komga.Client.Model
{
    ...
    /// EndsWith
    /// </summary>
    [DataContract(Name = "EndsWith")]
    public partial class EndsWith : StringOp, IValidatableObject
    {
        /// <summary>
        ...
        /// <param name="varOperator">varOperator (required) (default to &quot;EndsWith&quot;).</param>
        public EndsWith(string value = default, string varOperator = @"EndsWith") : base(varOperator)
        {
            // to ensure "value" is required (not null)
            if (value == null)
            {
                throw new ArgumentNullException("value is a required property for EndsWith and cannot be null");
            }
            this.Value = value;
        }
