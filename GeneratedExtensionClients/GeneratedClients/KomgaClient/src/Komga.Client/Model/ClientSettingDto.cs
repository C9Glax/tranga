...
namespace Komga.Client.Model
{
    ...
    /// ClientSettingDto
    /// </summary>
    [DataContract(Name = "ClientSettingDto")]
    public partial class ClientSettingDto : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ClientSettingDto" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected ClientSettingDto() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="ClientSettingDto" /> class.
        /// </summary>
        /// <param name="allowUnauthorized">allowUnauthorized.</param>
        /// <param name="value">value (required).</param>
        public ClientSettingDto(bool allowUnauthorized = default, string value = default)
        {
            // to ensure "value" is required (not null)
            if (value == null)
            {
                throw new ArgumentNullException("value is a required property for ClientSettingDto and cannot be null");
            }
            this.Value = value;
        ...
        /// </summary>
        [DataMember(Name = "allowUnauthorized", EmitDefaultValue = true)]
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ClientSettingDto {\n");
