...
namespace Komga.Client.Model
{
    ...
    /// AuthorUpdateDto
    /// </summary>
    [DataContract(Name = "AuthorUpdateDto")]
    public partial class AuthorUpdateDto : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="AuthorUpdateDto" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected AuthorUpdateDto() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="AuthorUpdateDto" /> class.
        /// </summary>
        /// <param name="name">name (required).</param>
        /// <param name="role">role (required).</param>
        public AuthorUpdateDto(string name = default, string role = default)
        {
            // to ensure "name" is required (not null)
            if (name == null)
            {
                throw new ArgumentNullException("name is a required property for AuthorUpdateDto and cannot be null");
            }
            this.Name = name;
            // to ensure "role" is required (not null)
            if (role == null)
            {
                throw new ArgumentNullException("role is a required property for AuthorUpdateDto and cannot be null");
            }
            this.Role = role;
        }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class AuthorUpdateDto {\n");
