...
namespace Komga.Client.Model
{
    ...
    /// IsNullT
    /// </summary>
    [DataContract(Name = "IsNullT")]
    public partial class IsNullT : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="IsNullT" /> class.
        /// </summary>
        ...
        public IsNullT(string varOperator = default)
        {
            // to ensure "varOperator" is required (not null)
            if (varOperator == null)
            {
                throw new ArgumentNullException("varOperator is a required property for IsNullT and cannot be null");
            }
