...
namespace Komga.Client.Model
{
    ...
    /// BeginsWith
    /// </summary>
    [DataContract(Name = "BeginsWith")]
    public partial class BeginsWith : StringOp, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="BeginsWith" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected BeginsWith() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="BeginsWith" /> class.
        /// </summary>
        /// <param name="value">value (required).</param>
        /// <param name="varOperator">varOperator (required) (default to &quot;BeginsWith&quot;).</param>
        public BeginsWith(string value = default, string varOperator = @"BeginsWith") : base(varOperator)
        {
            // to ensure "value" is required (not null)
            if (value == null)
            {
                throw new ArgumentNullException("value is a required property for BeginsWith and cannot be null");
            }
            this.Value = value;
        }
