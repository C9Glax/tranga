...
namespace Komga.Client.Model
{
    ...
    /// GreaterThan
    /// </summary>
    [DataContract(Name = "GreaterThan")]
    public partial class GreaterThan : IValidatableObject
    {
        /// <summary>
        ...
        public GreaterThan(string varOperator = default, Object value = default)
        {
            // to ensure "varOperator" is required (not null)
            if (varOperator == null)
            {
                throw new ArgumentNullException("varOperator is a required property for GreaterThan and cannot be null");
            }
            this.Operator = varOperator;
            // to ensure "value" is required (not null)
            if (value == null)
            {
                throw new ArgumentNullException("value is a required property for GreaterThan and cannot be null");
            }
            this.Value = value;
        }
