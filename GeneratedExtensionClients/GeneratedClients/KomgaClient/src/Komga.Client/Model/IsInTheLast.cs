...
namespace Komga.Client.Model
{
    ...
    /// IsInTheLast
    /// </summary>
    [DataContract(Name = "IsInTheLast")]
    public partial class IsInTheLast : Date, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="IsInTheLast" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected IsInTheLast() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="IsInTheLast" /> class.
        /// </summary>
        /// <param name="duration">duration (required).</param>
        /// <param name="varOperator">varOperator (required) (default to &quot;IsInTheLast&quot;).</param>
        public IsInTheLast(string duration = default, string varOperator = @"IsInTheLast") : base(varOperator)
        {
            // to ensure "duration" is required (not null)
            if (duration == null)
            {
                throw new ArgumentNullException("duration is a required property for IsInTheLast and cannot be null");
            }
