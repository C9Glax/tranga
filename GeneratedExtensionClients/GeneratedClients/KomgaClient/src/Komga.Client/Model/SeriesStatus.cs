...
namespace Komga.Client.Model
{
    ...
    /// SeriesStatus
    /// </summary>
    [DataContract(Name = "SeriesStatus")]
    public partial class SeriesStatus : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SeriesStatus" /> class.
        /// </summary>
        ...
        /// Initializes a new instance of the <see cref="SeriesStatus" /> class.
        /// </summary>
        /// <param name="varSeriesStatus">varSeriesStatus (required).</param>
        public SeriesStatus(SeriesStatusAllOfSeriesStatus varSeriesStatus = default)
        {
            // to ensure "varSeriesStatus" is required (not null)
            if (varSeriesStatus == null)
            {
                throw new ArgumentNullException("varSeriesStatus is a required property for SeriesStatus and cannot be null");
            }
            this.VarSeriesStatus = varSeriesStatus;
        }

        /// <summary>
        /// Gets or Sets VarSeriesStatus
        /// </summary>
        [DataMember(Name = "seriesStatus", IsRequired = true, EmitDefaultValue = true)]
        public SeriesStatusAllOfSeriesStatus VarSeriesStatus { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("  VarSeriesStatus: ").Append(VarSeriesStatus).Append("\n");
            sb.Append("}\n");
            return sb.ToString();
        }
