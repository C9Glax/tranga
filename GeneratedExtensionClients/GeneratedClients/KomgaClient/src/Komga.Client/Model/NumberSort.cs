...
namespace Komga.Client.Model
{
    ...
    /// NumberSort
    /// </summary>
    [DataContract(Name = "NumberSort")]
    public partial class NumberSort : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="NumberSort" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected NumberSort() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="NumberSort" /> class.
        /// </summary>
        /// <param name="varNumberSort">varNumberSort (required).</param>
        public NumberSort(NumberSortAllOfNumberSort varNumberSort = default)
        {
            // to ensure "varNumberSort" is required (not null)
            if (varNumberSort == null)
            {
                throw new ArgumentNullException("varNumberSort is a required property for NumberSort and cannot be null");
            }
            this.VarNumberSort = varNumberSort;
        }

        /// <summary>
        /// Gets or Sets VarNumberSort
        /// </summary>
        [DataMember(Name = "numberSort", IsRequired = true, EmitDefaultValue = true)]
        public NumberSortAllOfNumberSort VarNumberSort { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class NumberSort {\n");
            sb.Append("  VarNumberSort: ").Append(VarNumberSort).Append("\n");
            sb.Append("}\n");
            return sb.ToString();
        }
