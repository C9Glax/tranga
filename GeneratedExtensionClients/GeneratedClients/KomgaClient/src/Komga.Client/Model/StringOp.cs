...
namespace Komga.Client.Model
{
    ...
    /// StringOp
    /// </summary>
    [DataContract(Name = "StringOp")]
    [JsonConverter(typeof(JsonSubtypes), "Operator")]
    [JsonSubtypes.KnownSubType(typeof(BeginsWith), "BeginsWith")]
    [JsonSubtypes.KnownSubType(typeof(Contains), "Contains")]
    [JsonSubtypes.KnownSubType(typeof(DoesNotBeginWith), "DoesNotBeginWith")]
    [JsonSubtypes.KnownSubType(typeof(DoesNotContain), "DoesNotContain")]
    [JsonSubtypes.KnownSubType(typeof(DoesNotEndWith), "DoesNotEndWith")]
    [JsonSubtypes.KnownSubType(typeof(EndsWith), "EndsWith")]
    [JsonSubtypes.KnownSubType(typeof(Is), "Is")]
    [JsonSubtypes.KnownSubType(typeof(IsNot), "IsNot")]
    public partial class StringOp : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="StringOp" /> class.
        /// </summary>
        ...
        public StringOp(string varOperator = default)
        {
            // to ensure "varOperator" is required (not null)
            if (varOperator == null)
            {
                throw new ArgumentNullException("varOperator is a required property for StringOp and cannot be null");
            }
