...
namespace Komga.Client.Model
{
    ...
    /// EqualityAuthorMatch
    /// </summary>
    [DataContract(Name = "EqualityAuthorMatch")]
    public partial class EqualityAuthorMatch : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="EqualityAuthorMatch" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected EqualityAuthorMatch() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="EqualityAuthorMatch" /> class.
        /// </summary>
        /// <param name="varOperator">varOperator (required).</param>
        public EqualityAuthorMatch(string varOperator = default)
        {
            // to ensure "varOperator" is required (not null)
            if (varOperator == null)
            {
                throw new ArgumentNullException("varOperator is a required property for EqualityAuthorMatch and cannot be null");
            }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class EqualityAuthorMatch {\n");
