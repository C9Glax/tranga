...
namespace Komga.Client.Model
{
    ...
    /// PageHashUnknownDto
    /// </summary>
    [DataContract(Name = "PageHashUnknownDto")]
    public partial class PageHashUnknownDto : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PageHashUnknownDto" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected PageHashUnknownDto() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="PageHashUnknownDto" /> class.
        /// </summary>
        ...
        public PageHashUnknownDto(string hash = default, int matchCount = default, long size = default)
        {
            // to ensure "hash" is required (not null)
            if (hash == null)
            {
                throw new ArgumentNullException("hash is a required property for PageHashUnknownDto and cannot be null");
            }
            this.Hash = hash;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class PageHashUnknownDto {\n");
