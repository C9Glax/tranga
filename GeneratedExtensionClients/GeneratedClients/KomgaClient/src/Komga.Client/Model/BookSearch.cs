...
namespace Komga.Client.Model
{
    ...
    /// BookSearch
    /// </summary>
    [DataContract(Name = "BookSearch")]
    public partial class BookSearch : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="BookSearch" /> class.
        /// </summary>
        /// <param name="condition">condition.</param>
        /// <param name="fullTextSearch">fullTextSearch.</param>
        public BookSearch(AnyOfBookAllOfAnyOf condition = default, string fullTextSearch = default)
        {
        ...
        public AnyOfBookAllOfAnyOf Condition { get; set; }
