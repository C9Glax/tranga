...
namespace Komga.Client.Model
{
    ...
    public partial class Genre : IValidatableObject
    {
        ...
        /// Initializes a new instance of the <see cref="Genre" /> class.
        /// </summary>
        /// <param name="varGenre">varGenre (required).</param>
        public Genre(GenreAllOfGenre varGenre = default)
        {
            // to ensure "varGenre" is required (not null)
            if (varGenre == null)
            {
                throw new ArgumentNullException("varGenre is a required property for Genre and cannot be null");
            }
            this.VarGenre = varGenre;
        }

        /// <summary>
        /// Gets or Sets VarGenre
        /// </summary>
        [DataMember(Name = "genre", IsRequired = true, EmitDefaultValue = true)]
        public GenreAllOfGenre VarGenre { get; set; }
