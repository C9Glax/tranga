...
namespace Komga.Client.Model
{
    ...
    /// PageCollectionDto
    /// </summary>
    [DataContract(Name = "PageCollectionDto")]
    public partial class PageCollectionDto : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PageCollectionDto" /> class.
        /// </summary>
        ...
        public PageCollectionDto(List<CollectionDto> content = default, bool empty = default, bool first = default, bool last = default, int number = default, int numberOfElements = default, PageableObject pageable = default, int size = default, SortObject sort = default, long totalElements = default, int totalPages = default)
        {
        ...
        public List<CollectionDto> Content { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class PageCollectionDto {\n");
