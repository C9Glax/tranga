...
namespace Komga.Client.Model
{
    ...
    /// Deleted
    /// </summary>
    [DataContract(Name = "Deleted")]
    public partial class Deleted : IValidatableObject
    {
        /// <summary>
        ...
        /// Initializes a new instance of the <see cref="Deleted" /> class.
        /// </summary>
        /// <param name="varDeleted">varDeleted (required).</param>
        public Deleted(DeletedAllOfDeleted varDeleted = default)
        {
            // to ensure "varDeleted" is required (not null)
            if (varDeleted == null)
            {
                throw new ArgumentNullException("varDeleted is a required property for Deleted and cannot be null");
            }
            this.VarDeleted = varDeleted;
        }

        /// <summary>
        /// Gets or Sets VarDeleted
        /// </summary>
        [DataMember(Name = "deleted", IsRequired = true, EmitDefaultValue = true)]
        public DeletedAllOfDeleted VarDeleted { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("  VarDeleted: ").Append(VarDeleted).Append("\n");
            sb.Append("}\n");
            return sb.ToString();
        }
