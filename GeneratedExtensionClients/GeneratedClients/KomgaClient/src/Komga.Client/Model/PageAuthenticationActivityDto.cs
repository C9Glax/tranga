...
namespace Komga.Client.Model
{
    ...
    /// </summary>
    [DataContract(Name = "PageAuthenticationActivityDto")]
    public partial class PageAuthenticationActivityDto : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PageAuthenticationActivityDto" /> class.
        /// </summary>
        ...
        public PageAuthenticationActivityDto(List<AuthenticationActivityDto> content = default, bool empty = default, bool first = default, bool last = default, int number = default, int numberOfElements = default, PageableObject pageable = default, int size = default, SortObject sort = default, long totalElements = default, int totalPages = default)
        {
        ...
        public List<AuthenticationActivityDto> Content { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class PageAuthenticationActivityDto {\n");
