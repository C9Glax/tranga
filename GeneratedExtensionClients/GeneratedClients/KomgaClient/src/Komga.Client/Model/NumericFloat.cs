...
namespace Komga.Client.Model
{
    ...
    /// NumericFloat
    /// </summary>
    [DataContract(Name = "NumericFloat")]
    public partial class NumericFloat : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="NumericFloat" /> class.
        /// </summary>
        ...
        public NumericFloat(string varOperator = default)
        {
            // to ensure "varOperator" is required (not null)
            if (varOperator == null)
            {
                throw new ArgumentNullException("varOperator is a required property for NumericFloat and cannot be null");
            }
