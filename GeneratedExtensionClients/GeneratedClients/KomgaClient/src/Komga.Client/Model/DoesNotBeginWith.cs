...
namespace Komga.Client.Model
{
    ...
    /// DoesNotBeginWith
    /// </summary>
    [DataContract(Name = "DoesNotBeginWith")]
    public partial class DoesNotBeginWith : StringOp, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="DoesNotBeginWith" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected DoesNotBeginWith() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="DoesNotBeginWith" /> class.
        /// </summary>
        /// <param name="value">value (required).</param>
        /// <param name="varOperator">varOperator (required) (default to &quot;DoesNotBeginWith&quot;).</param>
        public DoesNotBeginWith(string value = default, string varOperator = @"DoesNotBeginWith") : base(varOperator)
        {
            // to ensure "value" is required (not null)
            if (value == null)
            {
                throw new ArgumentNullException("value is a required property for DoesNotBeginWith and cannot be null");
            }
            this.Value = value;
        }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class DoesNotBeginWith {\n");
