...
namespace Komga.Client.Model
{
    ...
    /// EqualityString
    /// </summary>
    [DataContract(Name = "EqualityString")]
    public partial class EqualityString : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="EqualityString" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected EqualityString() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="EqualityString" /> class.
        /// </summary>
        /// <param name="varOperator">varOperator (required).</param>
        public EqualityString(string varOperator = default)
        {
            // to ensure "varOperator" is required (not null)
            if (varOperator == null)
            {
                throw new ArgumentNullException("varOperator is a required property for EqualityString and cannot be null");
            }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class EqualityString {\n");
