...
namespace Komga.Client.Model
{
    ...
    /// </summary>
    [DataContract(Name = "ClientSettingGlobalUpdateDto")]
    public partial class ClientSettingGlobalUpdateDto : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ClientSettingGlobalUpdateDto" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected ClientSettingGlobalUpdateDto() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="ClientSettingGlobalUpdateDto" /> class.
        /// </summary>
        /// <param name="allowUnauthorized">allowUnauthorized (required).</param>
        /// <param name="value">value (required).</param>
        public ClientSettingGlobalUpdateDto(bool allowUnauthorized = default, string value = default)
        {
            this.AllowUnauthorized = allowUnauthorized;
            // to ensure "value" is required (not null)
            if (value == null)
            {
                throw new ArgumentNullException("value is a required property for ClientSettingGlobalUpdateDto and cannot be null");
            }
            this.Value = value;
        }

        /// <summary>
        /// Gets or Sets AllowUnauthorized
        /// </summary>
        [DataMember(Name = "allowUnauthorized", IsRequired = true, EmitDefaultValue = true)]
        public bool AllowUnauthorized { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ClientSettingGlobalUpdateDto {\n");
            sb.Append("  AllowUnauthorized: ").Append(AllowUnauthorized).Append("\n");
