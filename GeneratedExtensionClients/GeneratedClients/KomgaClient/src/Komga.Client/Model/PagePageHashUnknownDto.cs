...
namespace Komga.Client.Model
{
    ...
    /// </summary>
    [DataContract(Name = "PagePageHashUnknownDto")]
    public partial class PagePageHashUnknownDto : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PagePageHashUnknownDto" /> class.
        /// </summary>
        ...
        public PagePageHashUnknownDto(List<PageHashUnknownDto> content = default, bool empty = default, bool first = default, bool last = default, int number = default, int numberOfElements = default, PageableObject pageable = default, int size = default, SortObject sort = default, long totalElements = default, int totalPages = default)
        {
        ...
        public List<PageHashUnknownDto> Content { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class PagePageHashUnknownDto {\n");
