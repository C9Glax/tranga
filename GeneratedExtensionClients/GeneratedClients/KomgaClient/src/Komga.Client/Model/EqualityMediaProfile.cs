...
namespace Komga.Client.Model
{
    ...
    /// </summary>
    [DataContract(Name = "EqualityMediaProfile")]
    public partial class EqualityMediaProfile : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="EqualityMediaProfile" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected EqualityMediaProfile() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="EqualityMediaProfile" /> class.
        /// </summary>
        /// <param name="varOperator">varOperator (required).</param>
        public EqualityMediaProfile(string varOperator = default)
        {
            // to ensure "varOperator" is required (not null)
            if (varOperator == null)
            {
                throw new ArgumentNullException("varOperator is a required property for EqualityMediaProfile and cannot be null");
            }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class EqualityMediaProfile {\n");
