...
namespace Komga.Client.Model
{
    ...
    public partial class Language : IValidatableObject
    {
        ...
        /// Initializes a new instance of the <see cref="Language" /> class.
        /// </summary>
        /// <param name="varLanguage">varLanguage (required).</param>
        public Language(LanguageAllOfLanguage varLanguage = default)
        {
            // to ensure "varLanguage" is required (not null)
            if (varLanguage == null)
            {
                throw new ArgumentNullException("varLanguage is a required property for Language and cannot be null");
            }
            this.VarLanguage = varLanguage;
        }

        /// <summary>
        /// Gets or Sets VarLanguage
        /// </summary>
        [DataMember(Name = "language", IsRequired = true, EmitDefaultValue = true)]
        public LanguageAllOfLanguage VarLanguage { get; set; }
