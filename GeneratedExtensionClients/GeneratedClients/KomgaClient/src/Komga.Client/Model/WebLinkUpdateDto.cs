...
namespace Komga.Client.Model
{
    ...
    /// WebLinkUpdateDto
    /// </summary>
    [DataContract(Name = "WebLinkUpdateDto")]
    public partial class WebLinkUpdateDto : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="WebLinkUpdateDto" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected WebLinkUpdateDto() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="WebLinkUpdateDto" /> class.
        /// </summary>
        /// <param name="label">label (required).</param>
        /// <param name="url">url.</param>
        public WebLinkUpdateDto(string label = default, string url = default)
        {
            // to ensure "label" is required (not null)
            if (label == null)
            {
                throw new ArgumentNullException("label is a required property for WebLinkUpdateDto and cannot be null");
            }
            this.Label = label;
            this.Url = url;
        }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class WebLinkUpdateDto {\n");
