...
namespace Komga.Client.Model
{
    ...
    /// CollectionId
    /// </summary>
    [DataContract(Name = "CollectionId")]
    public partial class CollectionId : IValidatableObject
    {
        /// <summary>
        ...
        /// Initializes a new instance of the <see cref="CollectionId" /> class.
        /// </summary>
        /// <param name="varCollectionId">varCollectionId (required).</param>
        public CollectionId(CollectionIdAllOfCollectionId varCollectionId = default)
        {
            // to ensure "varCollectionId" is required (not null)
            if (varCollectionId == null)
            {
                throw new ArgumentNullException("varCollectionId is a required property for CollectionId and cannot be null");
            }
            this.VarCollectionId = varCollectionId;
        }

        /// <summary>
        /// Gets or Sets VarCollectionId
        /// </summary>
        [DataMember(Name = "collectionId", IsRequired = true, EmitDefaultValue = true)]
        public CollectionIdAllOfCollectionId VarCollectionId { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class CollectionId {\n");
            sb.Append("  VarCollectionId: ").Append(VarCollectionId).Append("\n");
            sb.Append("}\n");
            return sb.ToString();
        }
