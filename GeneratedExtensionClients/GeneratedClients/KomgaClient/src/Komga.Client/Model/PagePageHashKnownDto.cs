...
namespace Komga.Client.Model
{
    ...
    /// </summary>
    [DataContract(Name = "PagePageHashKnownDto")]
    public partial class PagePageHashKnownDto : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PagePageHashKnownDto" /> class.
        /// </summary>
        ...
        public PagePageHashKnownDto(List<PageHashKnownDto> content = default, bool empty = default, bool first = default, bool last = default, int number = default, int numberOfElements = default, PageableObject pageable = default, int size = default, SortObject sort = default, long totalElements = default, int totalPages = default)
        {
        ...
        public List<PageHashKnownDto> Content { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class PagePageHashKnownDto {\n");
