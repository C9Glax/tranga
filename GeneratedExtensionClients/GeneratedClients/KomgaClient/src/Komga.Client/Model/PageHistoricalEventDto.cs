...
namespace Komga.Client.Model
{
    ...
    /// </summary>
    [DataContract(Name = "PageHistoricalEventDto")]
    public partial class PageHistoricalEventDto : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PageHistoricalEventDto" /> class.
        /// </summary>
        ...
        public PageHistoricalEventDto(List<HistoricalEventDto> content = default, bool empty = default, bool first = default, bool last = default, int number = default, int numberOfElements = default, PageableObject pageable = default, int size = default, SortObject sort = default, long totalElements = default, int totalPages = default)
        {
        ...
        public List<HistoricalEventDto> Content { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class PageHistoricalEventDto {\n");
