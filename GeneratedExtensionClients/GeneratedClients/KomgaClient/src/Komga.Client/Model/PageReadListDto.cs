...
namespace Komga.Client.Model
{
    ...
    /// PageReadListDto
    /// </summary>
    [DataContract(Name = "PageReadListDto")]
    public partial class PageReadListDto : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PageReadListDto" /> class.
        /// </summary>
        ...
        public PageReadListDto(List<ReadListDto> content = default, bool empty = default, bool first = default, bool last = default, int number = default, int numberOfElements = default, PageableObject pageable = default, int size = default, SortObject sort = default, long totalElements = default, int totalPages = default)
        {
        ...
        public List<ReadListDto> Content { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class PageReadListDto {\n");
