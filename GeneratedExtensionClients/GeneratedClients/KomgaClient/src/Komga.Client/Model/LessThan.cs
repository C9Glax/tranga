...
namespace Komga.Client.Model
{
    ...
    /// LessThan
    /// </summary>
    [DataContract(Name = "LessThan")]
    public partial class LessThan : IValidatableObject
    {
        /// <summary>
        ...
        public LessThan(string varOperator = default, Object value = default)
        {
            // to ensure "varOperator" is required (not null)
            if (varOperator == null)
            {
                throw new ArgumentNullException("varOperator is a required property for LessThan and cannot be null");
            }
            this.Operator = varOperator;
            // to ensure "value" is required (not null)
            if (value == null)
            {
                throw new ArgumentNullException("value is a required property for LessThan and cannot be null");
            }
            this.Value = value;
        }
