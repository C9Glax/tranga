...
namespace Komga.Client.Model
{
    ...
    [JsonSubtypes.KnownSubType(typeof(After), "After")]
    [JsonSubtypes.KnownSubType(typeof(Before), "Before")]
    [JsonSubtypes.KnownSubType(typeof(IsInTheLast), "IsInTheLast")]
    [JsonSubtypes.KnownSubType(typeof(IsNotInTheLast), "IsNotInTheLast")]
    [JsonSubtypes.KnownSubType(typeof(IsNotNull), "IsNotNull")]
    [JsonSubtypes.KnownSubType(typeof(IsNull), "IsNull")]
    public partial class Date : IValidatableObject
    {
        /// <summary>
        ...
        public Date(string varOperator = default)
        {
            // to ensure "varOperator" is required (not null)
            if (varOperator == null)
            {
                throw new ArgumentNullException("varOperator is a required property for Date and cannot be null");
            }
