...
namespace Komga.Client.Model
{
    ...
    /// </summary>
    [DataContract(Name = "TachiyomiReadProgressUpdateDto")]
    public partial class TachiyomiReadProgressUpdateDto : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TachiyomiReadProgressUpdateDto" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected TachiyomiReadProgressUpdateDto() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="TachiyomiReadProgressUpdateDto" /> class.
        /// </summary>
        /// <param name="lastBookRead">lastBookRead (required).</param>
        public TachiyomiReadProgressUpdateDto(int lastBookRead = default)
        {
            this.LastBookRead = lastBookRead;
        }

        /// <summary>
        /// Gets or Sets LastBookRead
        /// </summary>
        [DataMember(Name = "lastBookRead", IsRequired = true, EmitDefaultValue = true)]
        public int LastBookRead { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TachiyomiReadProgressUpdateDto {\n");
            sb.Append("  LastBookRead: ").Append(LastBookRead).Append("\n");
            sb.Append("}\n");
            return sb.ToString();
        }
