...
namespace Komga.Client.Model
{
    ...
    /// R2Device
    /// </summary>
    [DataContract(Name = "R2Device")]
    public partial class R2Device : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="R2Device" /> class.
        /// </summary>
        ...
        public R2Device(string id = default, string name = default)
        {
            // to ensure "id" is required (not null)
            if (id == null)
            {
                throw new ArgumentNullException("id is a required property for R2Device and cannot be null");
            }
            this.Id = id;
            // to ensure "name" is required (not null)
            if (name == null)
            {
                throw new ArgumentNullException("name is a required property for R2Device and cannot be null");
            }
            this.Name = name;
        }
