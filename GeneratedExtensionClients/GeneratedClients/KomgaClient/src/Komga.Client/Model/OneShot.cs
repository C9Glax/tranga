...
namespace Komga.Client.Model
{
    ...
    /// OneShot
    /// </summary>
    [DataContract(Name = "OneShot")]
    public partial class OneShot : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="OneShot" /> class.
        /// </summary>
        ...
        /// Initializes a new instance of the <see cref="OneShot" /> class.
        /// </summary>
        /// <param name="varOneShot">varOneShot (required).</param>
        public OneShot(OneShotAllOfOneShot varOneShot = default)
        {
            // to ensure "varOneShot" is required (not null)
            if (varOneShot == null)
            {
                throw new ArgumentNullException("varOneShot is a required property for OneShot and cannot be null");
            }
            this.VarOneShot = varOneShot;
        }

        /// <summary>
        /// Gets or Sets VarOneShot
        /// </summary>
        [DataMember(Name = "oneShot", IsRequired = true, EmitDefaultValue = true)]
        public OneShotAllOfOneShot VarOneShot { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class OneShot {\n");
            sb.Append("  VarOneShot: ").Append(VarOneShot).Append("\n");
            sb.Append("}\n");
            return sb.ToString();
        }
