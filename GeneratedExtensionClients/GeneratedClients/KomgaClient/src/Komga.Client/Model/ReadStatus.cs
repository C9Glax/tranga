...
namespace Komga.Client.Model
{
    ...
    /// ReadStatus
    /// </summary>
    [DataContract(Name = "ReadStatus")]
    public partial class ReadStatus : IValidatableObject
    {
        /// <summary>
        ...
        /// Initializes a new instance of the <see cref="ReadStatus" /> class.
        /// </summary>
        /// <param name="varReadStatus">varReadStatus (required).</param>
        public ReadStatus(ReadStatusAllOfReadStatus varReadStatus = default)
        {
            // to ensure "varReadStatus" is required (not null)
            if (varReadStatus == null)
            {
                throw new ArgumentNullException("varReadStatus is a required property for ReadStatus and cannot be null");
            }
            this.VarReadStatus = varReadStatus;
        }

        /// <summary>
        /// Gets or Sets VarReadStatus
        /// </summary>
        [DataMember(Name = "readStatus", IsRequired = true, EmitDefaultValue = true)]
        public ReadStatusAllOfReadStatus VarReadStatus { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ReadStatus {\n");
            sb.Append("  VarReadStatus: ").Append(VarReadStatus).Append("\n");
            sb.Append("}\n");
            return sb.ToString();
        }
