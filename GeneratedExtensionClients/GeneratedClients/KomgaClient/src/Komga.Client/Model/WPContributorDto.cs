...
namespace Komga.Client.Model
{
    ...
    /// WPContributorDto
    /// </summary>
    [DataContract(Name = "WPContributorDto")]
    public partial class WPContributorDto : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="WPContributorDto" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected WPContributorDto() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="WPContributorDto" /> class.
        /// </summary>
        ...
        public WPContributorDto(List<WPLinkDto> links = default, string name = default, float position = default)
        {
            // to ensure "links" is required (not null)
            if (links == null)
            {
                throw new ArgumentNullException("links is a required property for WPContributorDto and cannot be null");
            }
            this.Links = links;
            // to ensure "name" is required (not null)
            if (name == null)
            {
                throw new ArgumentNullException("name is a required property for WPContributorDto and cannot be null");
            }
            this.Name = name;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class WPContributorDto {\n");
