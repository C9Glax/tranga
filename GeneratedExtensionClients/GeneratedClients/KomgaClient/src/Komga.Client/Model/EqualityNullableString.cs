...
namespace Komga.Client.Model
{
    ...
    /// </summary>
    [DataContract(Name = "EqualityNullableString")]
    public partial class EqualityNullableString : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="EqualityNullableString" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected EqualityNullableString() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="EqualityNullableString" /> class.
        /// </summary>
        /// <param name="varOperator">varOperator (required).</param>
        public EqualityNullableString(string varOperator = default)
        {
            // to ensure "varOperator" is required (not null)
            if (varOperator == null)
            {
                throw new ArgumentNullException("varOperator is a required property for EqualityNullableString and cannot be null");
            }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class EqualityNullableString {\n");
