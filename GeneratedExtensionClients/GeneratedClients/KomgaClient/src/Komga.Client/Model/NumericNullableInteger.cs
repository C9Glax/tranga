...
namespace Komga.Client.Model
{
    ...
    /// </summary>
    [DataContract(Name = "NumericNullableInteger")]
    public partial class NumericNullableInteger : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="NumericNullableInteger" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected NumericNullableInteger() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="NumericNullableInteger" /> class.
        /// </summary>
        /// <param name="varOperator">varOperator (required).</param>
        public NumericNullableInteger(string varOperator = default)
        {
            // to ensure "varOperator" is required (not null)
            if (varOperator == null)
            {
                throw new ArgumentNullException("varOperator is a required property for NumericNullableInteger and cannot be null");
            }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class NumericNullableInteger {\n");
