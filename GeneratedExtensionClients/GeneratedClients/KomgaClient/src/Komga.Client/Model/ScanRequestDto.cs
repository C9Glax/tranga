...
namespace Komga.Client.Model
{
    ...
    /// ScanRequestDto
    /// </summary>
    [DataContract(Name = "ScanRequestDto")]
    public partial class ScanRequestDto : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ScanRequestDto" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected ScanRequestDto() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="ScanRequestDto" /> class.
        /// </summary>
        /// <param name="path">path (required).</param>
        public ScanRequestDto(string path = default)
        {
            // to ensure "path" is required (not null)
            if (path == null)
            {
                throw new ArgumentNullException("path is a required property for ScanRequestDto and cannot be null");
            }
            this.Path = path;
        }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ScanRequestDto {\n");
