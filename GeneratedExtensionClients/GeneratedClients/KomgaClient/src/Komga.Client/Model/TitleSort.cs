...
namespace Komga.Client.Model
{
    ...
    /// TitleSort
    /// </summary>
    [DataContract(Name = "TitleSort")]
    public partial class TitleSort : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TitleSort" /> class.
        /// </summary>
        ...
        /// Initializes a new instance of the <see cref="TitleSort" /> class.
        /// </summary>
        /// <param name="varTitleSort">varTitleSort (required).</param>
        public TitleSort(TitleSortAllOfTitleSort varTitleSort = default)
        {
            // to ensure "varTitleSort" is required (not null)
            if (varTitleSort == null)
            {
                throw new ArgumentNullException("varTitleSort is a required property for TitleSort and cannot be null");
            }
            this.VarTitleSort = varTitleSort;
        }

        /// <summary>
        /// Gets or Sets VarTitleSort
        /// </summary>
        [DataMember(Name = "titleSort", IsRequired = true, EmitDefaultValue = true)]
        public TitleSortAllOfTitleSort VarTitleSort { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TitleSort {\n");
            sb.Append("  VarTitleSort: ").Append(VarTitleSort).Append("\n");
            sb.Append("}\n");
            return sb.ToString();
        }
