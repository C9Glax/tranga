...
namespace Komga.Client.Model
{
    ...
    public partial class ValidationErrorResponse : IValidatableObject
    {
        ...
        /// Initializes a new instance of the <see cref="ValidationErrorResponse" /> class.
        /// </summary>
        /// <param name="violations">violations (required).</param>
        public ValidationErrorResponse(List<Violation> violations = default)
        {
            // to ensure "violations" is required (not null)
            if (violations == null)
            {
                throw new ArgumentNullException("violations is a required property for ValidationErrorResponse and cannot be null");
            }
