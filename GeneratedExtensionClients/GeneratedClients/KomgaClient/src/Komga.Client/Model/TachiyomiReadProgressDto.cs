...
namespace Komga.Client.Model
{
    ...
    /// </summary>
    [DataContract(Name = "TachiyomiReadProgressDto")]
    public partial class TachiyomiReadProgressDto : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TachiyomiReadProgressDto" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected TachiyomiReadProgressDto() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="TachiyomiReadProgressDto" /> class.
        /// </summary>
        ...
        /// <param name="lastReadContinuousIndex">lastReadContinuousIndex (required).</param>
        public TachiyomiReadProgressDto(int booksCount = default, int booksInProgressCount = default, int booksReadCount = default, int booksUnreadCount = default, int lastReadContinuousIndex = default)
        {
        ...
        /// <summary>
        /// Gets or Sets LastReadContinuousIndex
        /// </summary>
        [DataMember(Name = "lastReadContinuousIndex", IsRequired = true, EmitDefaultValue = true)]
        public int LastReadContinuousIndex { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TachiyomiReadProgressDto {\n");
            ...
            sb.Append("  LastReadContinuousIndex: ").Append(LastReadContinuousIndex).Append("\n");
            sb.Append("}\n");
            return sb.ToString();
        }
