...
namespace Komga.Client.Model
{
    ...
    /// IsNotNullT
    /// </summary>
    [DataContract(Name = "IsNotNullT")]
    public partial class IsNotNullT : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="IsNotNullT" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected IsNotNullT() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="IsNotNullT" /> class.
        /// </summary>
        /// <param name="varOperator">varOperator (required).</param>
        public IsNotNullT(string varOperator = default)
        {
            // to ensure "varOperator" is required (not null)
            if (varOperator == null)
            {
                throw new ArgumentNullException("varOperator is a required property for IsNotNullT and cannot be null");
            }
