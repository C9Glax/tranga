...
namespace Komga.Client.Model
{
    ...
    /// SharingLabel
    /// </summary>
    [DataContract(Name = "SharingLabel")]
    public partial class SharingLabel : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SharingLabel" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected SharingLabel() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="SharingLabel" /> class.
        /// </summary>
        /// <param name="varSharingLabel">varSharingLabel (required).</param>
        public SharingLabel(SharingLabelAllOfSharingLabel varSharingLabel = default)
        {
            // to ensure "varSharingLabel" is required (not null)
            if (varSharingLabel == null)
            {
                throw new ArgumentNullException("varSharingLabel is a required property for SharingLabel and cannot be null");
            }
            this.VarSharingLabel = varSharingLabel;
        }

        /// <summary>
        /// Gets or Sets VarSharingLabel
        /// </summary>
        [DataMember(Name = "sharingLabel", IsRequired = true, EmitDefaultValue = true)]
        public SharingLabelAllOfSharingLabel VarSharingLabel { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class SharingLabel {\n");
            sb.Append("  VarSharingLabel: ").Append(VarSharingLabel).Append("\n");
            sb.Append("}\n");
            return sb.ToString();
        }
