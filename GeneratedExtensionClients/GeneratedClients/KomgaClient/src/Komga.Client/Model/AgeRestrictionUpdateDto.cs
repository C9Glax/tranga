...
namespace Komga.Client.Model
{
    ...
    /// </summary>
    [DataContract(Name = "AgeRestrictionUpdateDto")]
    public partial class AgeRestrictionUpdateDto : IValidatableObject
    {
        /// <summary>
        /// Defines Restriction
        /// </summary>
        ...
        {
            /// <summary>
            /// Enum ALLOWONLY for value: ALLOW_ONLY
            /// </summary>
            [EnumMember(Value = "ALLOW_ONLY")]
            ALLOWONLY = 1,
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="AgeRestrictionUpdateDto" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected AgeRestrictionUpdateDto() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="AgeRestrictionUpdateDto" /> class.
        /// </summary>
        /// <param name="age">age (required).</param>
        /// <param name="restriction">restriction (required).</param>
        public AgeRestrictionUpdateDto(int age = default, RestrictionEnum restriction = default)
        {
            this.Age = age;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class AgeRestrictionUpdateDto {\n");
