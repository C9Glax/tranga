...
namespace Komga.Client.Model
{
    ...
    /// </summary>
    [DataContract(Name = "ReadListRequestBookMatchBookDto")]
    public partial class ReadListRequestBookMatchBookDto : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ReadListRequestBookMatchBookDto" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected ReadListRequestBookMatchBookDto() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="ReadListRequestBookMatchBookDto" /> class.
        /// </summary>
        ...
        public ReadListRequestBookMatchBookDto(string bookId = default, string number = default, string title = default)
        {
            // to ensure "bookId" is required (not null)
            if (bookId == null)
            {
                throw new ArgumentNullException("bookId is a required property for ReadListRequestBookMatchBookDto and cannot be null");
            }
            this.BookId = bookId;
            // to ensure "number" is required (not null)
            if (number == null)
            {
                throw new ArgumentNullException("number is a required property for ReadListRequestBookMatchBookDto and cannot be null");
            }
            this.Number = number;
            // to ensure "title" is required (not null)
            if (title == null)
            {
                throw new ArgumentNullException("title is a required property for ReadListRequestBookMatchBookDto and cannot be null");
            }
            this.Title = title;
        }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ReadListRequestBookMatchBookDto {\n");
