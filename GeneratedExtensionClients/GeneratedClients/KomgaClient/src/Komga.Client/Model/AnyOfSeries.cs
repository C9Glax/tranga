...
namespace Komga.Client.Model
{
    ...
    /// AnyOfSeries
    /// </summary>
    [DataContract(Name = "AnyOfSeries")]
    public partial class AnyOfSeries : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="AnyOfSeries" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected AnyOfSeries() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="AnyOfSeries" /> class.
        /// </summary>
        /// <param name="anyOf">anyOf (required).</param>
        public AnyOfSeries(List<AnyOfSeriesAllOfAnyOf> anyOf = default)
        {
            // to ensure "anyOf" is required (not null)
            if (anyOf == null)
            {
                throw new ArgumentNullException("anyOf is a required property for AnyOfSeries and cannot be null");
            }
            this.AnyOf = anyOf;
        }
        ...
        public List<AnyOfSeriesAllOfAnyOf> AnyOf { get; set; }
