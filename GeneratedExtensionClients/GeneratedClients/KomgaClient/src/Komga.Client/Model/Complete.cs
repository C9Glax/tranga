...
namespace Komga.Client.Model
{
    ...
    /// Complete
    /// </summary>
    [DataContract(Name = "Complete")]
    public partial class Complete : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="Complete" /> class.
        /// </summary>
        ...
        /// Initializes a new instance of the <see cref="Complete" /> class.
        /// </summary>
        /// <param name="varComplete">varComplete (required).</param>
        public Complete(CompleteAllOfComplete varComplete = default)
        {
            // to ensure "varComplete" is required (not null)
            if (varComplete == null)
            {
                throw new ArgumentNullException("varComplete is a required property for Complete and cannot be null");
            }
            this.VarComplete = varComplete;
        }

        /// <summary>
        /// Gets or Sets VarComplete
        /// </summary>
        [DataMember(Name = "complete", IsRequired = true, EmitDefaultValue = true)]
        public CompleteAllOfComplete VarComplete { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class Complete {\n");
            sb.Append("  VarComplete: ").Append(VarComplete).Append("\n");
            sb.Append("}\n");
            return sb.ToString();
        }
