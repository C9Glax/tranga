...
namespace Komga.Client.Model
{
    ...
    /// IsNotInTheLast
    /// </summary>
    [DataContract(Name = "IsNotInTheLast")]
    public partial class IsNotInTheLast : Date, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="IsNotInTheLast" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected IsNotInTheLast() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="IsNotInTheLast" /> class.
        /// </summary>
        /// <param name="duration">duration (required).</param>
        /// <param name="varOperator">varOperator (required) (default to &quot;IsNotInTheLast&quot;).</param>
        public IsNotInTheLast(string duration = default, string varOperator = @"IsNotInTheLast") : base(varOperator)
        {
            // to ensure "duration" is required (not null)
            if (duration == null)
            {
                throw new ArgumentNullException("duration is a required property for IsNotInTheLast and cannot be null");
            }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class IsNotInTheLast {\n");
