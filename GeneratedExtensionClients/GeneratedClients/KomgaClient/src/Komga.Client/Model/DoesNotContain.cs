...
namespace Komga.Client.Model
{
    ...
    /// DoesNotContain
    /// </summary>
    [DataContract(Name = "DoesNotContain")]
    public partial class DoesNotContain : StringOp, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="DoesNotContain" /> class.
        /// </summary>
        ...
        /// <param name="varOperator">varOperator (required) (default to &quot;DoesNotContain&quot;).</param>
        public DoesNotContain(string value = default, string varOperator = @"DoesNotContain") : base(varOperator)
        {
            // to ensure "value" is required (not null)
            if (value == null)
            {
                throw new ArgumentNullException("value is a required property for DoesNotContain and cannot be null");
            }
            this.Value = value;
        }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class DoesNotContain {\n");
