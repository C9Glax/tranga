...
namespace Komga.Client.Model
{
    ...
    /// PageAuthorDto
    /// </summary>
    [DataContract(Name = "PageAuthorDto")]
    public partial class PageAuthorDto : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PageAuthorDto" /> class.
        /// </summary>
        ...
        public PageAuthorDto(List<AuthorDto> content = default, bool empty = default, bool first = default, bool last = default, int number = default, int numberOfElements = default, PageableObject pageable = default, int size = default, SortObject sort = default, long totalElements = default, int totalPages = default)
        {
        ...
        public List<AuthorDto> Content { get; set; }
