...
namespace Komga.Client.Model
{
    ...
    /// </summary>
    [DataContract(Name = "ThumbnailSeriesCollectionDto")]
    public partial class ThumbnailSeriesCollectionDto : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ThumbnailSeriesCollectionDto" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected ThumbnailSeriesCollectionDto() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="ThumbnailSeriesCollectionDto" /> class.
        /// </summary>
        ...
        public ThumbnailSeriesCollectionDto(string collectionId = default, long fileSize = default, int height = default, string id = default, string mediaType = default, bool selected = default, string type = default, int width = default)
        {
            // to ensure "collectionId" is required (not null)
            if (collectionId == null)
            {
                throw new ArgumentNullException("collectionId is a required property for ThumbnailSeriesCollectionDto and cannot be null");
            }
            ...
            if (id == null)
            {
                throw new ArgumentNullException("id is a required property for ThumbnailSeriesCollectionDto and cannot be null");
            }
            this.Id = id;
            // to ensure "mediaType" is required (not null)
            if (mediaType == null)
            {
                throw new ArgumentNullException("mediaType is a required property for ThumbnailSeriesCollectionDto and cannot be null");
            }
            ...
            if (type == null)
            {
                throw new ArgumentNullException("type is a required property for ThumbnailSeriesCollectionDto and cannot be null");
            }
            this.Type = type;
            this.Width = width;
        }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ThumbnailSeriesCollectionDto {\n");
