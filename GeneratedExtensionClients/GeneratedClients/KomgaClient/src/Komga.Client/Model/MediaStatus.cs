...
namespace Komga.Client.Model
{
    ...
    /// MediaStatus
    /// </summary>
    [DataContract(Name = "MediaStatus")]
    public partial class MediaStatus : IValidatableObject
    {
        /// <summary>
        ...
        /// Initializes a new instance of the <see cref="MediaStatus" /> class.
        /// </summary>
        /// <param name="varMediaStatus">varMediaStatus (required).</param>
        public MediaStatus(MediaStatusAllOfMediaStatus varMediaStatus = default)
        {
            // to ensure "varMediaStatus" is required (not null)
            if (varMediaStatus == null)
            {
                throw new ArgumentNullException("varMediaStatus is a required property for MediaStatus and cannot be null");
            }
            this.VarMediaStatus = varMediaStatus;
        }

        /// <summary>
        /// Gets or Sets VarMediaStatus
        /// </summary>
        [DataMember(Name = "mediaStatus", IsRequired = true, EmitDefaultValue = true)]
        public MediaStatusAllOfMediaStatus VarMediaStatus { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("  VarMediaStatus: ").Append(VarMediaStatus).Append("\n");
            sb.Append("}\n");
            return sb.ToString();
        }
