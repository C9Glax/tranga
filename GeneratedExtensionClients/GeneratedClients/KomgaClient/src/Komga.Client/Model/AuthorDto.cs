...
namespace Komga.Client.Model
{
    ...
    /// AuthorDto
    /// </summary>
    [DataContract(Name = "AuthorDto")]
    public partial class AuthorDto : IValidatableObject
    {
        /// <summary>
        ...
        public AuthorDto(string name = default, string role = default)
        {
            // to ensure "name" is required (not null)
            if (name == null)
            {
                throw new ArgumentNullException("name is a required property for AuthorDto and cannot be null");
            }
            this.Name = name;
            // to ensure "role" is required (not null)
            if (role == null)
            {
                throw new ArgumentNullException("role is a required property for AuthorDto and cannot be null");
            }
            this.Role = role;
        }
