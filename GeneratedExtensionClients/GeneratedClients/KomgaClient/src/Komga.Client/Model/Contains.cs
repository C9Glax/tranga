...
namespace Komga.Client.Model
{
    ...
    /// Contains
    /// </summary>
    [DataContract(Name = "Contains")]
    public partial class Contains : StringOp, IValidatableObject
    {
        /// <summary>
        ...
        /// <param name="varOperator">varOperator (required) (default to &quot;Contains&quot;).</param>
        public Contains(string value = default, string varOperator = @"Contains") : base(varOperator)
        {
            // to ensure "value" is required (not null)
            if (value == null)
            {
                throw new ArgumentNullException("value is a required property for Contains and cannot be null");
            }
            this.Value = value;
        }
