...
namespace Komga.Client.Model
{
    ...
    /// AgeRating
    /// </summary>
    [DataContract(Name = "AgeRating")]
    public partial class AgeRating : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="AgeRating" /> class.
        /// </summary>
        ...
        /// Initializes a new instance of the <see cref="AgeRating" /> class.
        /// </summary>
        /// <param name="varAgeRating">varAgeRating (required).</param>
        public AgeRating(AgeRatingAllOfAgeRating varAgeRating = default)
        {
            // to ensure "varAgeRating" is required (not null)
            if (varAgeRating == null)
            {
                throw new ArgumentNullException("varAgeRating is a required property for AgeRating and cannot be null");
            }
            this.VarAgeRating = varAgeRating;
        }

        /// <summary>
        /// Gets or Sets VarAgeRating
        /// </summary>
        [DataMember(Name = "ageRating", IsRequired = true, EmitDefaultValue = true)]
        public AgeRatingAllOfAgeRating VarAgeRating { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class AgeRating {\n");
            sb.Append("  VarAgeRating: ").Append(VarAgeRating).Append("\n");
            sb.Append("}\n");
            return sb.ToString();
        }
