...
namespace Komga.Client.Model
{
    ...
    /// ReadListId
    /// </summary>
    [DataContract(Name = "ReadListId")]
    public partial class ReadListId : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ReadListId" /> class.
        /// </summary>
        ...
        /// Initializes a new instance of the <see cref="ReadListId" /> class.
        /// </summary>
        /// <param name="varReadListId">varReadListId (required).</param>
        public ReadListId(ReadListIdAllOfReadListId varReadListId = default)
        {
            // to ensure "varReadListId" is required (not null)
            if (varReadListId == null)
            {
                throw new ArgumentNullException("varReadListId is a required property for ReadListId and cannot be null");
            }
            this.VarReadListId = varReadListId;
        }

        /// <summary>
        /// Gets or Sets VarReadListId
        /// </summary>
        [DataMember(Name = "readListId", IsRequired = true, EmitDefaultValue = true)]
        public ReadListIdAllOfReadListId VarReadListId { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ReadListId {\n");
            sb.Append("  VarReadListId: ").Append(VarReadListId).Append("\n");
            sb.Append("}\n");
            return sb.ToString();
        }
