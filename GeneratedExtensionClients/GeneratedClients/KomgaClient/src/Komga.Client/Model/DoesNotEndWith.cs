...
namespace Komga.Client.Model
{
    ...
    /// DoesNotEndWith
    /// </summary>
    [DataContract(Name = "DoesNotEndWith")]
    public partial class DoesNotEndWith : StringOp, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="DoesNotEndWith" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected DoesNotEndWith() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="DoesNotEndWith" /> class.
        /// </summary>
        /// <param name="value">value (required).</param>
        /// <param name="varOperator">varOperator (required) (default to &quot;DoesNotEndWith&quot;).</param>
        public DoesNotEndWith(string value = default, string varOperator = @"DoesNotEndWith") : base(varOperator)
        {
            // to ensure "value" is required (not null)
            if (value == null)
            {
                throw new ArgumentNullException("value is a required property for DoesNotEndWith and cannot be null");
            }
            this.Value = value;
        }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class DoesNotEndWith {\n");
