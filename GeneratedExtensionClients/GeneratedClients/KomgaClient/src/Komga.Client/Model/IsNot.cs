...
namespace Komga.Client.Model
{
    ...
    /// IsNot
    /// </summary>
    [DataContract(Name = "IsNot")]
    public partial class IsNot : IValidatableObject
    {
        /// <summary>
        ...
        public IsNot(string varOperator = default, Object value = default)
        {
            // to ensure "varOperator" is required (not null)
            if (varOperator == null)
            {
                throw new ArgumentNullException("varOperator is a required property for IsNot and cannot be null");
            }
            this.Operator = varOperator;
            // to ensure "value" is required (not null)
            if (value == null)
            {
                throw new ArgumentNullException("value is a required property for IsNot and cannot be null");
            }
            this.Value = value;
        }
