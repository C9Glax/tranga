...
namespace Komga.Client.Model
{
    ...
    public partial class ReleaseDate : IValidatableObject
    {
        /// <summary>
        ...
        /// Initializes a new instance of the <see cref="ReleaseDate" /> class.
        /// </summary>
        /// <param name="varReleaseDate">varReleaseDate (required).</param>
        public ReleaseDate(ReleaseDateAllOfReleaseDate varReleaseDate = default)
        {
            // to ensure "varReleaseDate" is required (not null)
            if (varReleaseDate == null)
            {
                throw new ArgumentNullException("varReleaseDate is a required property for ReleaseDate and cannot be null");
            }
            this.VarReleaseDate = varReleaseDate;
        }

        /// <summary>
        /// Gets or Sets VarReleaseDate
        /// </summary>
        [DataMember(Name = "releaseDate", IsRequired = true, EmitDefaultValue = true)]
        public ReleaseDateAllOfReleaseDate VarReleaseDate { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ReleaseDate {\n");
            sb.Append("  VarReleaseDate: ").Append(VarReleaseDate).Append("\n");
            sb.Append("}\n");
            return sb.ToString();
        }
