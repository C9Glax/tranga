...
namespace Komga.Client.Model
{
    ...
    /// AllOfSeries
    /// </summary>
    [DataContract(Name = "AllOfSeries")]
    public partial class AllOfSeries : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="AllOfSeries" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected AllOfSeries() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="AllOfSeries" /> class.
        /// </summary>
        /// <param name="allOf">allOf (required).</param>
        public AllOfSeries(List<AllOfSeriesAllOfAllOf> allOf = default)
        {
            // to ensure "allOf" is required (not null)
            if (allOf == null)
            {
                throw new ArgumentNullException("allOf is a required property for AllOfSeries and cannot be null");
            }
            this.AllOf = allOf;
        }
        ...
        public List<AllOfSeriesAllOfAllOf> AllOf { get; set; }
