...
namespace Komga.Client.Model
{
    ...
    /// AgeRestrictionDto
    /// </summary>
    [DataContract(Name = "AgeRestrictionDto")]
    public partial class AgeRestrictionDto : IValidatableObject
    {
        /// <summary>
        /// Defines Restriction
        /// </summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="AgeRestrictionDto" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected AgeRestrictionDto() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="AgeRestrictionDto" /> class.
        /// </summary>
        /// <param name="age">age (required).</param>
        /// <param name="restriction">restriction (required).</param>
        public AgeRestrictionDto(int age = default, RestrictionEnum restriction = default)
        {
            this.Age = age;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class AgeRestrictionDto {\n");
