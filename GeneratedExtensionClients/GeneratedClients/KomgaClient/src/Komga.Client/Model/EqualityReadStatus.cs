...
namespace Komga.Client.Model
{
    ...
    /// EqualityReadStatus
    /// </summary>
    [DataContract(Name = "EqualityReadStatus")]
    public partial class EqualityReadStatus : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="EqualityReadStatus" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected EqualityReadStatus() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="EqualityReadStatus" /> class.
        /// </summary>
        /// <param name="varOperator">varOperator (required).</param>
        public EqualityReadStatus(string varOperator = default)
        {
            // to ensure "varOperator" is required (not null)
            if (varOperator == null)
            {
                throw new ArgumentNullException("varOperator is a required property for EqualityReadStatus and cannot be null");
            }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class EqualityReadStatus {\n");
