...
namespace Komga.Client.Model
{
    ...
    /// </summary>
    [DataContract(Name = "AlternateTitleUpdateDto")]
    public partial class AlternateTitleUpdateDto : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="AlternateTitleUpdateDto" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected AlternateTitleUpdateDto() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="AlternateTitleUpdateDto" /> class.
        /// </summary>
        /// <param name="label">label (required).</param>
        /// <param name="title">title (required).</param>
        public AlternateTitleUpdateDto(string label = default, string title = default)
        {
            // to ensure "label" is required (not null)
            if (label == null)
            {
                throw new ArgumentNullException("label is a required property for AlternateTitleUpdateDto and cannot be null");
            }
            this.Label = label;
            // to ensure "title" is required (not null)
            if (title == null)
            {
                throw new ArgumentNullException("title is a required property for AlternateTitleUpdateDto and cannot be null");
            }
            this.Title = title;
        }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class AlternateTitleUpdateDto {\n");
