...
namespace Komga.Client.Model
{
    ...
    public partial class After : Date, IValidatableObject
    {
        /// <summary>
        ...
        /// <param name="varOperator">varOperator (required) (default to &quot;After&quot;).</param>
        public After(DateTime dateTime = default, string varOperator = @"After") : base(varOperator)
        {
