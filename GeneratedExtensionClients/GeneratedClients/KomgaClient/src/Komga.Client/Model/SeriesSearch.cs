...
namespace Komga.Client.Model
{
    ...
    /// SeriesSearch
    /// </summary>
    [DataContract(Name = "SeriesSearch")]
    public partial class SeriesSearch : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SeriesSearch" /> class.
        /// </summary>
        /// <param name="condition">condition.</param>
        /// <param name="fullTextSearch">fullTextSearch.</param>
        public SeriesSearch(AnyOfSeriesAllOfAnyOf condition = default, string fullTextSearch = default)
        {
        ...
        public AnyOfSeriesAllOfAnyOf Condition { get; set; }

        /// <summary>
        /// Gets or Sets FullTextSearch
        /// </summary>
        [DataMember(Name = "fullTextSearch", EmitDefaultValue = false)]
        ...
        public override string ToString()
        {
            ...
            sb.Append("class SeriesSearch {\n");
            sb.Append("  Condition: ").Append(Condition).Append("\n");
            sb.Append("  FullTextSearch: ").Append(FullTextSearch).Append("\n");
            sb.Append("}\n");
            return sb.ToString();
        }
