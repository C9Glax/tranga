...
namespace Komga.Client.Model
{
    ...
    public partial class Title : IValidatableObject
    {
        /// <summary>
        ...
        /// Initializes a new instance of the <see cref="Title" /> class.
        /// </summary>
        /// <param name="varTitle">varTitle (required).</param>
        public Title(TitleAllOfTitle varTitle = default)
        {
            // to ensure "varTitle" is required (not null)
            if (varTitle == null)
            {
                throw new ArgumentNullException("varTitle is a required property for Title and cannot be null");
            }
            this.VarTitle = varTitle;
        }

        /// <summary>
        /// Gets or Sets VarTitle
        /// </summary>
        [DataMember(Name = "title", IsRequired = true, EmitDefaultValue = true)]
        public TitleAllOfTitle VarTitle { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("  VarTitle: ").Append(VarTitle).Append("\n");
            sb.Append("}\n");
            return sb.ToString();
        }
