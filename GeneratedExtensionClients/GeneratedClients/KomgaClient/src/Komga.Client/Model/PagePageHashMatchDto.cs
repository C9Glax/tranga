...
namespace Komga.Client.Model
{
    ...
    /// </summary>
    [DataContract(Name = "PagePageHashMatchDto")]
    public partial class PagePageHashMatchDto : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PagePageHashMatchDto" /> class.
        /// </summary>
        ...
        public PagePageHashMatchDto(List<PageHashMatchDto> content = default, bool empty = default, bool first = default, bool last = default, int number = default, int numberOfElements = default, PageableObject pageable = default, int size = default, SortObject sort = default, long totalElements = default, int totalPages = default)
        {
        ...
        public List<PageHashMatchDto> Content { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class PagePageHashMatchDto {\n");
