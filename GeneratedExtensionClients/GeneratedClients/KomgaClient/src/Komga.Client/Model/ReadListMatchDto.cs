...
namespace Komga.Client.Model
{
    ...
    /// ReadListMatchDto
    /// </summary>
    [DataContract(Name = "ReadListMatchDto")]
    public partial class ReadListMatchDto : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ReadListMatchDto" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected ReadListMatchDto() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="ReadListMatchDto" /> class.
        /// </summary>
        /// <param name="errorCode">errorCode (required).</param>
        /// <param name="name">name (required).</param>
        public ReadListMatchDto(string errorCode = default, string name = default)
        {
            // to ensure "errorCode" is required (not null)
            if (errorCode == null)
            {
                throw new ArgumentNullException("errorCode is a required property for ReadListMatchDto and cannot be null");
            }
            this.ErrorCode = errorCode;
            // to ensure "name" is required (not null)
            if (name == null)
            {
                throw new ArgumentNullException("name is a required property for ReadListMatchDto and cannot be null");
            }
            this.Name = name;
        }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ReadListMatchDto {\n");
