...
namespace Komga.Client.Model
{
    ...
    /// ReadListCreationDto
    /// </summary>
    [DataContract(Name = "ReadListCreationDto")]
    public partial class ReadListCreationDto : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ReadListCreationDto" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected ReadListCreationDto() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="ReadListCreationDto" /> class.
        /// </summary>
        ...
        public ReadListCreationDto(List<string> bookIds = default, string name = default, bool ordered = default, string summary = default)
        {
            // to ensure "bookIds" is required (not null)
            if (bookIds == null)
            {
                throw new ArgumentNullException("bookIds is a required property for ReadListCreationDto and cannot be null");
            }
            this.BookIds = bookIds;
            // to ensure "name" is required (not null)
            if (name == null)
            {
                throw new ArgumentNullException("name is a required property for ReadListCreationDto and cannot be null");
            }
            this.Name = name;
            ...
            if (summary == null)
            {
                throw new ArgumentNullException("summary is a required property for ReadListCreationDto and cannot be null");
            }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ReadListCreationDto {\n");
