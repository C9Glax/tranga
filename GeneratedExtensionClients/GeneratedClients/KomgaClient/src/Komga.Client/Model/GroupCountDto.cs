...
namespace Komga.Client.Model
{
    ...
    /// GroupCountDto
    /// </summary>
    [DataContract(Name = "GroupCountDto")]
    public partial class GroupCountDto : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="GroupCountDto" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected GroupCountDto() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="GroupCountDto" /> class.
        /// </summary>
        /// <param name="count">count (required).</param>
        /// <param name="group">group (required).</param>
        public GroupCountDto(int count = default, string group = default)
        {
            this.Count = count;
            // to ensure "group" is required (not null)
            if (group == null)
            {
                throw new ArgumentNullException("group is a required property for GroupCountDto and cannot be null");
            }
            this.Group = group;
        }
