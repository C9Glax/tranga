...
namespace Komga.Client.Model
{
    ...
    /// IsNull
    /// </summary>
    [DataContract(Name = "IsNull")]
    public partial class IsNull : Date, IValidatableObject
    {
        /// <summary>
        ...
        /// Initializes a new instance of the <see cref="IsNull" /> class.
        /// </summary>
        /// <param name="varOperator">varOperator (required) (default to &quot;IsNull&quot;).</param>
        public IsNull(string varOperator = @"IsNull") : base(varOperator)
        {
        }
