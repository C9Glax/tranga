...
namespace Komga.Client.Model
{
    ...
    /// ClaimStatus
    /// </summary>
    [DataContract(Name = "ClaimStatus")]
    public partial class ClaimStatus : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ClaimStatus" /> class.
        /// </summary>
        ...
        /// Initializes a new instance of the <see cref="ClaimStatus" /> class.
        /// </summary>
        /// <param name="isClaimed">isClaimed (required).</param>
        public ClaimStatus(bool isClaimed = default)
        {
        ...
        /// </summary>
        [DataMember(Name = "isClaimed", IsRequired = true, EmitDefaultValue = true)]
