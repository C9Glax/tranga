...
namespace Komga.Client.Model
{
    ...
    /// MediaProfile
    /// </summary>
    [DataContract(Name = "MediaProfile")]
    public partial class MediaProfile : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="MediaProfile" /> class.
        /// </summary>
        ...
        /// Initializes a new instance of the <see cref="MediaProfile" /> class.
        /// </summary>
        /// <param name="varMediaProfile">varMediaProfile (required).</param>
        public MediaProfile(MediaProfileAllOfMediaProfile varMediaProfile = default)
        {
            // to ensure "varMediaProfile" is required (not null)
            if (varMediaProfile == null)
            {
                throw new ArgumentNullException("varMediaProfile is a required property for MediaProfile and cannot be null");
            }
            this.VarMediaProfile = varMediaProfile;
        }

        /// <summary>
        /// Gets or Sets VarMediaProfile
        /// </summary>
        [DataMember(Name = "mediaProfile", IsRequired = true, EmitDefaultValue = true)]
        public MediaProfileAllOfMediaProfile VarMediaProfile { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class MediaProfile {\n");
            sb.Append("  VarMediaProfile: ").Append(VarMediaProfile).Append("\n");
            sb.Append("}\n");
            return sb.ToString();
        }
