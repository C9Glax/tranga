...
public class MangaDex : MangaConnector
{
    ...
    public MangaDex(string mangaConnectorName) : base(mangaConnectorName, new HttpDownloadClient())
    {
    }
    ...
    private (Manga, Author[], MangaTag[], Link[], MangaAltTitle[])? MangaFromJsonObject(JsonObject manga)
    {
        ...
        Manga pub = new(MangaConnectorName, title, description, coverUrl, null, year,
