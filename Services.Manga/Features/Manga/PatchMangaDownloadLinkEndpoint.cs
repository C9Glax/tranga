...
public abstract class PatchMangaDownloadLinkEndpoint
{
    ...
    public static async Task<Results<Ok, NotFound>> Handle(MangaContext mangaContext, [FromRoute]Guid mangaId, [FromRoute]Guid downloadId, [FromBody]PatchMangaDownloadLinkRequest req, CancellationToken ct)
    {
