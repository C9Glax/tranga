...
/// <summary>
/// Join entity linking a <see cref="DbMetadata"/> entry to a <see cref="DbPerson"/> credited as an author.
/// </summary>
public sealed record DbMangaAuthors
{
    ...
    /// <summary>The metadata entry this author is associated with.</summary>
    public DbMetadata? Metadata { get; internal set; }

    /// <summary>The person credited as an author of the metadata entry.</summary>
