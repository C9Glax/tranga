...
public struct EnvVars
{
    ...
    public static readonly string? MAL_CLIENT_ID = string.IsNullOrEmpty(Environment.GetEnvironmentVariable("MAL_CLIENT_ID")) ? null : Environment.GetEnvironmentVariable("MAL_CLIENT_ID");
