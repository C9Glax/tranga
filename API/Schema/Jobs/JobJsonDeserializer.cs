...
public class JobJsonDeserializer : JsonConverter<Job>
{
    ...
    public override Job? ReadJson(JsonReader reader, Type objectType, Job? existingValue, bool hasExistingValue, JsonSerializer serializer)
    {
        ...
        return type switch
        {
            JobType.CreateArchiveJob => j.ToObject<CreateArchiveJob>(),
            ...
            JobType.CreateComicInfoXmlJob => j.ToObject<CreateComicInfoXmlJob>(),
            JobType.ProcessImagesJob => j.ToObject<ProcessImagesJob>(),
            JobType.SearchMangaJob => j.ToObject<SearchMangaJob>(),
