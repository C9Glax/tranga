...
public abstract class GetListMangaEndpoint
{
    ...
    public static async Task<Results<Ok<MangaDTO[]>, InternalServerError>> Handle(MangaContext mangaContext, [FromQuery]GetMangaEndpoint.Includes[] includes, CancellationToken ct)
    {
        // TODO Pagination
